...
docker run --name [name of your data container] jonasbonno/ftb-revelation:2.5.0 echo 'Data-only container'

Running ftb-revelation server:
docker run --tty=true --interactive=true --detach=true --name=[name of your container] --volumes-from [name of your data container] --publish=[port on your host]:25565 jonasbonno/ftb-revelation:2.5.0
